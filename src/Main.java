...
public class Main {
    public static void main(String[] args) {
        ...
        FindWinner w1 = new FindWinner(p1.playername, p2.playername, straightFlush1, straightFlush2, isStraight1, isStraight2, duplicateCards1, duplicateCards2, p1.flush(), p2.flush(), length1, length2, matchingRanks1, matchingRanks2, comparisonResultValue, comparisonResult);
...
class FindWinner {
    ...
    FindWinner(String playername1, String playername2, boolean straightFlush1, boolean straightFlush2, boolean straight1, boolean straight2, int duplicateCards1, int duplicateCards2, boolean flush1, boolean flush2, int length1, int length2, List<String> matchingRanks1, List<String> matchingRanks2, int comparisonResultValue, int comparisonResult) {
        ...
        this.comparisonResultValue = comparisonResultValue;
    ...
    void findHand() {
        ...
        if (straightFlush1) {
            ...
            winnerName = playername1;
        } else if (!straightFlush2 && duplicateCards1 == 3 && length1 == 2 && duplicateCards2 < 4) {
            System.out.println(playername1 + " has full house!");
            winnerName = playername1;
        ...
        if (straightFlush2) {
            ...
            winnerName = playername2;
        } else if (!straightFlush1 && duplicateCards2 == 3 && length2 == 2 && duplicateCards1 < 4) {
                System.out.println(playername1 + " has full house!");
                winnerName = playername1;
